...
<header>
	<div class="row">
		<div class="zone1">
			...
			<svg version="1.1" id="RBS" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
				viewBox="0 0 180 119" style="enable-background:new 0 0 180 119;" xml:space="preserve" width="190" height="119">
				<style type="text/css">
					.st0{fill:#01519A;}
					.st1{fill:none;stroke:#01519A;stroke-miterlimit:10;}
					.st2{fill:#B1D2FF;}
				</style>
				<g>
				<rect y="18.78" class="st0" width="24.89" height="100.22"/>
				<path class="st0" d="M28,45.15h24c0,0,3.11-0.04,3.11,4.26c0,4.04-3.7,3.59-3.7,3.59L28,53.09V45.15z"/>
				<path class="st1" d="M122.66,44.63c0,0,0.08,2.69,0.07,4.22c0.11,4.76-2.69,10.76-6.81,10.65"/>
				<path class="st0" d="M28,27v2.96c0,0,28.15,0.37,31.41,0.37c4.07,0,14.15,2.07,14.07,16C73.41,59.52,61.7,61.3,61.7,61.3
					c8.44,3.04,9.33,10.59,9.33,10.59l0.07,20.07L52.3,91.89c0,0-0.07-12.74,0-18.15c0.07-5.41-4.15-4.85-4.15-4.85H28v24.93
					l142.96,0.44V27H28z M138.36,30.91c7.11,0.04,26.59,0,26.59,0s0.52,13.63,0,14.07c-0.52,0.44-41.11,0.22-41.11,0.22
					C124.03,36.13,132.69,30.91,138.36,30.91z M108.59,91.72c-12.07,0.07-31.56,0-31.56,0v-15.7l23.85-0.07c0,0,2.9-0.44,2.87-4.07
					c-0.03-3.81-3.02-3.78-3.02-3.78l-23.7-0.07V53.09h24.22c0,0,2.67-0.36,2.67-3.97c0-4-3.04-3.97-3.04-3.97H77.04V30.02
					c0,0,23.56,0,31.94,0c6.01,0,12.93,4.37,13.22,14.81c0,0,0.11,3.17,0.06,4.22c-0.17,3.15-0.22,9.56-6.32,10.44v1.13
					c0,0,7.19,2.57,7.11,10.72l0,6.59C123.04,77.94,120.67,91.65,108.59,91.72z M168.51,75.17c0.03,7.26-8.37,16.96-16.59,16.96
					c-12.89,0-26.78-0.37-26.78-0.37V76.24h23.11c0,0,2.26-0.52,2.19-4.22c-0.07-3.7-2.3-3.93-2.63-3.93c-0.33,0-9.67,0-9.67,0
					s-14.44-3.87-14.3-16.03c0,0,19.19,0,26.52,0c7.56,0,18,6.73,18.15,17.47C168.51,69.54,168.58,73.39,168.51,75.17z"/>
				<path class="st2" d="M146.19,18.78V0L28,18.78V27h142.96v67.26L28,93.81v8.93l152,0.09V18.78H146.19z M138.14,18.78H82.58
					l55.56-9.28V18.78z"/>
				<g>
					<path class="st0" d="M30.67,110.93v2.84h0.64v0.87h-2.95v-0.87h0.77v-6.94h-0.77v-0.87h3.31c0.83,0,1.46,0.19,1.91,0.57
						c0.45,0.38,0.67,0.91,0.67,1.61c0,0.59-0.12,1.09-0.37,1.5s-0.62,0.73-1.12,0.96l2.03,3.18h0.51v0.87h-1.97l-2.07-3.7H30.67z
						M30.67,110.09h0.27c0.58,0,1.02-0.16,1.31-0.47s0.44-0.78,0.44-1.4c0-0.47-0.13-0.82-0.38-1.05s-0.63-0.35-1.13-0.35h-0.51
						V110.09z"/>
					<path class="st0" d="M41.82,114.63H36v-0.87h0.77v-6.94H36v-0.87h5.58v1.73h-0.83v-0.87h-2.37v2.89h1.6v-0.58h0.77v2.03h-0.77
						v-0.58h-1.6v3.11h2.62v-0.94h0.83V114.63z"/>
					<path class="st0" d="M48.22,114.72l-3.82-6.15v5.2h0.77v0.87h-2.59v-0.87h0.77v-6.94h-0.77v-0.87h1.86l3.82,6.19v-5.33H47.5v-0.87
						h2.59v0.87h-0.77v7.89H48.22z"/>
					<path class="st0" d="M52.66,112.12l-0.58,1.65h0.77v0.87h-2.08v-0.87h0.45l2.77-7.92h1.2l2.77,7.92h0.45v0.87h-2.87v-0.87h0.77
						l-0.58-1.65H52.66z M52.98,111.21h2.45l-1.23-3.49L52.98,111.21z"/>
					<path class="st0" d="M59.65,106.83h-0.77v-0.87h3.14v0.87h-0.77v4.54c0,0.91,0.13,1.58,0.4,1.99s0.69,0.62,1.27,0.62
						c0.57,0,0.97-0.2,1.21-0.6c0.24-0.4,0.35-1.08,0.35-2.04v-4.51h-0.77v-0.87h2.69v0.87h-0.77v4.35c0,0.75-0.05,1.32-0.16,1.71
						s-0.3,0.76-0.58,1.1c-0.49,0.57-1.21,0.86-2.15,0.86c-1.05,0-1.83-0.29-2.34-0.86c-0.51-0.57-0.76-1.46-0.76-2.65V106.83z"/>
					<path class="st0" d="M67.11,114.63v-0.87h0.77v-6.94h-0.77v-0.87h3.79c1.22,0,2.17,0.37,2.85,1.1c0.68,0.74,1.02,1.76,1.02,3.07
						c0,1.36-0.33,2.45-0.99,3.27s-1.55,1.22-2.65,1.22H67.11z M69.49,113.69h0.89c0.9,0,1.58-0.3,2.03-0.89
						c0.45-0.6,0.68-1.49,0.68-2.67c0-1.1-0.23-1.93-0.7-2.48c-0.47-0.55-1.17-0.82-2.11-0.82h-0.78V113.69z"/>
					<path class="st0" d="M83.06,110.13c0.71,0.16,1.24,0.43,1.6,0.82c0.35,0.39,0.53,0.9,0.53,1.52c0,0.72-0.21,1.26-0.64,1.62
						s-1.06,0.54-1.91,0.54h-3.41v-0.87H80v-6.94h-0.77v-0.87h3.41c0.71,0,1.26,0.17,1.65,0.5s0.58,0.81,0.58,1.42
						c0,0.5-0.15,0.94-0.45,1.32S83.66,109.88,83.06,110.13z M81.45,109.75h0.31c0.52,0,0.91-0.13,1.17-0.4s0.39-0.66,0.39-1.2
						c0-0.48-0.12-0.83-0.35-1.03s-0.63-0.3-1.19-0.3h-0.33V109.75z M81.45,113.76h0.35c0.64,0,1.1-0.11,1.38-0.34
						c0.28-0.23,0.42-0.6,0.42-1.12c0-0.5-0.17-0.92-0.52-1.24c-0.34-0.32-0.79-0.48-1.33-0.48h-0.31V113.76z"/>
					<path class="st0" d="M88.47,106.83v6.94h0.77v0.87H86.1v-0.87h0.77v-6.94H86.1v-0.87h3.14v0.87H88.47z"/>
					<path class="st0" d="M95.71,114.72l-3.82-6.15v5.2h0.77v0.87h-2.59v-0.87h0.77v-6.94h-0.77v-0.87h1.86l3.82,6.19v-5.33h-0.77
						v-0.87h2.59v0.87h-0.77v7.89H95.71z"/>
					<path class="st0" d="M98.42,114.63v-0.87h0.77v-6.94h-0.77v-0.87h3.79c1.22,0,2.17,0.37,2.85,1.1c0.68,0.74,1.03,1.76,1.03,3.07
						c0,1.36-0.33,2.45-0.99,3.27c-0.66,0.82-1.55,1.22-2.66,1.22H98.42z M100.79,113.69h0.89c0.9,0,1.58-0.3,2.03-0.89
						s0.68-1.49,0.68-2.67c0-1.1-0.23-1.93-0.7-2.48c-0.47-0.55-1.17-0.82-2.11-0.82h-0.78V113.69z"/>
					<path class="st0" d="M109.38,106.83v6.94h0.77v0.87h-3.14v-0.87h0.77v-6.94h-0.77v-0.87h3.14v0.87H109.38z"/>
					<path class="st0" d="M116.62,114.72l-3.82-6.15v5.2h0.77v0.87h-2.59v-0.87h0.77v-6.94h-0.77v-0.87h1.86l3.82,6.19v-5.33h-0.77
						v-0.87h2.59v0.87h-0.77v7.89H116.62z"/>
					<path class="st0" d="M125.97,114.45c-1.05,0.27-1.92,0.4-2.61,0.4c-1.21,0-2.17-0.41-2.88-1.23c-0.71-0.82-1.06-1.93-1.06-3.33
						c0-1.44,0.35-2.56,1.05-3.35c0.7-0.79,1.69-1.19,2.97-1.19c0.45,0,0.9,0.03,1.33,0.09s0.86,0.15,1.27,0.28v1.84h-0.87l-0.06-0.87
						c-0.28-0.16-0.56-0.28-0.84-0.36c-0.27-0.08-0.55-0.12-0.82-0.12c-0.73,0-1.29,0.33-1.71,0.99c-0.41,0.66-0.62,1.57-0.62,2.72
						c0,1.13,0.23,2.02,0.69,2.67c0.46,0.65,1.09,0.98,1.89,0.98c0.22,0,0.44-0.04,0.66-0.13v-2.26h-0.77v-0.87h2.95v0.87h-0.58V114.45
						z"/>
					<path class="st0" d="M131.14,114.5v-1.92h0.9v0.9c0.26,0.18,0.5,0.31,0.72,0.4s0.44,0.13,0.64,0.13c0.38,0,0.69-0.12,0.93-0.35
						s0.35-0.55,0.35-0.93c0-0.36-0.07-0.66-0.22-0.88c-0.15-0.22-0.44-0.47-0.87-0.73l-0.51-0.32c-0.7-0.43-1.19-0.85-1.48-1.26
						c-0.29-0.4-0.44-0.86-0.44-1.38c0-0.71,0.23-1.29,0.68-1.74c0.46-0.45,1.05-0.68,1.77-0.68c0.38,0,0.75,0.03,1.12,0.09
						s0.74,0.15,1.11,0.27v1.76h-0.9v-0.83c-0.22-0.15-0.43-0.27-0.63-0.34s-0.4-0.11-0.6-0.11c-0.29,0-0.54,0.12-0.75,0.35
						s-0.31,0.52-0.31,0.86c0,0.27,0.07,0.51,0.22,0.7c0.15,0.2,0.43,0.43,0.84,0.7l0.52,0.34c0.75,0.48,1.26,0.92,1.55,1.31
						c0.28,0.39,0.43,0.86,0.43,1.41c0,0.79-0.26,1.43-0.78,1.9s-1.22,0.71-2.09,0.71c-0.32,0-0.67-0.03-1.03-0.09
						S131.55,114.61,131.14,114.5z"/>
					<path class="st0" d="M139.51,110.87l-2.17-4.04h-0.45v-0.87h2.88v0.87h-0.64l1.63,3.01l1.61-3.01h-0.63v-0.87h1.99v0.87h-0.45
						l-2.17,4.04v2.89h0.77v0.87h-3.14v-0.87h0.77V110.87z"/>
					<path class="st0" d="M144.58,114.5v-1.92h0.9v0.9c0.26,0.18,0.5,0.31,0.72,0.4s0.44,0.13,0.64,0.13c0.38,0,0.69-0.12,0.93-0.35
						s0.35-0.55,0.35-0.93c0-0.36-0.07-0.66-0.22-0.88c-0.15-0.22-0.44-0.47-0.87-0.73l-0.51-0.32c-0.7-0.43-1.19-0.85-1.48-1.26
						c-0.29-0.4-0.44-0.86-0.44-1.38c0-0.71,0.23-1.29,0.68-1.74c0.46-0.45,1.05-0.68,1.77-0.68c0.38,0,0.75,0.03,1.12,0.09
						s0.74,0.15,1.11,0.27v1.76h-0.9v-0.83c-0.22-0.15-0.43-0.27-0.63-0.34s-0.4-0.11-0.6-0.11c-0.29,0-0.54,0.12-0.75,0.35
						s-0.31,0.52-0.31,0.86c0,0.27,0.07,0.51,0.22,0.7c0.15,0.2,0.43,0.43,0.84,0.7l0.52,0.34c0.75,0.48,1.26,0.92,1.55,1.31
						c0.28,0.39,0.43,0.86,0.43,1.41c0,0.79-0.26,1.43-0.78,1.9s-1.22,0.71-2.09,0.71c-0.32,0-0.67-0.03-1.03-0.09
						S144.99,114.61,144.58,114.5z"/>
					<path class="st0" d="M153.18,106.9h-1.95v0.94h-0.83v-1.88h7.17v1.88h-0.83v-0.94h-1.95v6.87h0.77v0.87h-3.14v-0.87h0.77V106.9z"
						/>
					<path class="st0" d="M164.11,114.63h-5.82v-0.87h0.77v-6.94h-0.77v-0.87h5.58v1.73h-0.83v-0.87h-2.37v2.89h1.6v-0.58h0.77v2.03
						h-0.77v-0.58h-1.6v3.11h2.62v-0.94h0.83V114.63z"/>
					<path class="st0" d="M165.64,113.76v-6.94h-0.77v-0.87h2.41l2.16,5.72l2.19-5.72h2.14v0.87H173v6.94h0.77v0.87h-2.82v-0.87h0.64
						l-0.01-5.51l-2.08,5.44h-0.76l-2.05-5.5v5.57h0.67v0.87h-2.49v-0.87H165.64z"/>
					<path class="st0" d="M174.78,114.5v-1.92h0.9v0.9c0.26,0.18,0.5,0.31,0.72,0.4s0.44,0.13,0.64,0.13c0.38,0,0.69-0.12,0.93-0.35
						s0.35-0.55,0.35-0.93c0-0.36-0.07-0.66-0.22-0.88c-0.15-0.22-0.44-0.47-0.87-0.73l-0.51-0.32c-0.7-0.43-1.19-0.85-1.48-1.26
						c-0.29-0.4-0.44-0.86-0.44-1.38c0-0.71,0.23-1.29,0.68-1.74c0.46-0.45,1.05-0.68,1.77-0.68c0.38,0,0.75,0.03,1.12,0.09
						s0.74,0.15,1.11,0.27v1.76h-0.9v-0.83c-0.22-0.15-0.43-0.27-0.63-0.34s-0.4-0.11-0.6-0.11c-0.29,0-0.54,0.12-0.75,0.35
						s-0.31,0.52-0.31,0.86c0,0.27,0.07,0.51,0.22,0.7c0.15,0.2,0.43,0.43,0.84,0.7l0.52,0.34c0.75,0.48,1.26,0.92,1.55,1.31
						c0.28,0.39,0.43,0.86,0.43,1.41c0,0.79-0.26,1.43-0.78,1.9s-1.22,0.71-2.09,0.71c-0.32,0-0.67-0.03-1.03-0.09
						S175.19,114.61,174.78,114.5z"/>
				</g>
				</g>
			</svg>
			</a>
		...
		<div class="zone2">
		<h1 class="titrepage">Systèmes bureautiques et professionnels pour la reliure, <br>
		la plastification et la finition de documents</h1>
		<p class="textpage">Nos technico-commerciaux régionaux sont à votre disposition du lundi au vendredi de 8h45 à 17h30 <br>Tél : + 33 (0) 3 84 78 30 30 - E-mail : <a href="mailto:contact@rbs-france.fr"></a><b><i>contact@rbs-france.fr</i></b></p>
		<div class="formpage">
		<!--formulaire de recherche  -->
		<form action="search_account.php" method="get">	
			<label for="query">Rechercher :</label>
				<input class="select1" type="text" id="query" name="query" placeholder="(référence, nom, ...)" required>
				<button class="bouton1" type="submit">OK</button>
		</form>
		</div>
		</div>
		<!-- boutons d'administration -->
    	<div class="zone3 top-bar">
		...
		<?php if (!empty($panier_articles)): ?>
			<div class="panier">
				...
				<svg version="1.1" id="Calque_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
					viewBox="0 0 45.93 38.81" style="enable-background:new 0 0 45.93 38.81;" xml:space="preserve">
					<style type="text/css">
						.st4{fill:#3D3D3D;}
						.st51{fill:#FFFFFF;}
						.st6{fill:#01519A;}
					...
					<g>
						<circle class="st4" cx="15.61" cy="35.7" r="3.11"/>
						<circle class="st5" cx="15.61" cy="35.7" r="1.37"/>
					</g>
					<g>
						<circle class="st4" cx="37.7" cy="35.7" r="3.11"/>
						<circle class="st5" cx="37.7" cy="35.7" r="1.37"/>
					</g>
					<path class="st6" d="M42.53,32.59c0,0.74-0.83,0.7-0.83,0.7H12.5c0,0-3.87-0.09-3.79-3.79c0.07-3.32,2.24-3.61,2.24-3.61L7.46,6.64
						V6.62C7.4,6.17,7.31,5.79,7.21,5.45C6.39,2.86,4.37,3.27,4.37,3.27V3.25c-0.3,0.68-0.99,1.16-1.78,1.16c-1.08,0-1.96-0.88-1.96-1.97
						c0-1.08,0.88-1.96,1.96-1.96c0.79,0,1.48,0.48,1.78,1.16V1.61c4.54-0.2,5.33,4.8,5.33,4.8l3.94,19.45l25.7,0.09l4.22-16.97
						l2.36-0.07l-4.55,18.5l-0.25,0.93L12.5,28.29c0,0-1.31-0.09-1.32,1.28c0,1.35,1.19,1.28,1.72,1.3c6.97-0.01,27.77-0.06,27.77-0.06
						S42.53,31.85,42.53,32.59z"/>
					<polygon class="st6" points="10.81,8.32 14.26,24.93 38.79,24.93 43.37,6.43 36.05,4.55 33.98,12.16 24.31,6.32 21.54,11.49 
						20.37,6.55 "/>
				</svg>
			</div>
        <?php else: ?>
	...
	<div class="prepa">
		...
		<!-- security -->
			<!-- Generator: Adobe Illustrator 28.6.0, SVG Export Plug-In . SVG Version: 9.03 Build 54939)  -->
			<svg class="logo" version="1.1" id="security" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
				viewBox="0 0 45.93 38.81" style="enable-background:new 0 0 45.93 38.81;" xml:space="preserve">
				<style type="text/css">
					.st0{fill:#01519A;}
					.st1{fill:#FFFFFF;}
				...
				<g>
					<path class="st0" d="M41.44,5.59v13.82c0,0-3.69,19.23-17.78,19.4h-0.07C9.51,38.64,5.81,19.41,5.81,19.41V5.59
						c0,0,4.78,2.89,9.56-1.78c4.51-4.4,7.89-3.89,8.26-3.82c0.41-0.08,3.78-0.55,8.26,3.82C36.66,8.48,41.44,5.59,41.44,5.59z"/>
					<path class="st1" d="M15.2,28.15h17V15.93h-2.67l-0.06-4.78c0,0-0.13-4.89-5.81-4.83c-5.69,0.06-5.74,4.78-5.74,4.78l-0.06,4.67
						l-2.67,0.06V28.15z"/>
					<path class="st0" d="M19.87,15.85h7.59v-4.67c0,0-0.3-3.04-3.8-2.96s-3.8,2.96-3.8,2.96V15.85z"/>
					<rect x="17.02" y="17.78" class="st0" width="13.26" height="8.44"/>
					<path class="st1" d="M23.75,21.75l1.01,3.42h-2.82l1.01-3.42c-0.58-0.16-1.01-0.7-1.01-1.34c0-0.79,0.63-1.42,1.41-1.42
						c0.78,0,1.41,0.63,1.41,1.42C24.76,21.05,24.33,21.59,23.75,21.75z"/>
				</g>
			</svg>
			<p class="textligne1">Paiement sécurisé</p>
		<!-- camion -->
			<!-- Generator: Adobe Illustrator 28.6.0, SVG Export Plug-In . SVG Version: 9.03 Build 54939)  -->
			<svg class="logo" version="1.1" id="Calque_3" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
				...
				<path class="st8" d="M28.48,34.09H2.31c-1.13,0-2.06-0.93-2.06-2.06V8.76c0-1.13,0.93-2.06,2.06-2.06h24.11
					c1.13,0,2.06,0.92,2.06,2.06V34.09z"/>
				<path class="st9" d="M45.93,32.15c0,0-0.22,1.94-1.78,1.94c-1.56,0-15.39,0-15.39,0V13.31h11.28c0,0,1.56-0.17,2.33,1.89
					c0.78,2.06,3,7.51,3,7.51s0.56,0.77,0.56,1.6C45.93,25.15,45.93,32.15,45.93,32.15z"/>
				<path class="st8" d="M34.04,15.15c0,0-1-0.06-1.06,1.11c-0.06,1.17,0,6.45,0,6.45s-0.11,0.99,1.06,0.99s7.33,0,7.33,0
					s1.37-0.28,1.28-1.56c-0.05-0.75-0.5-1.69-0.8-2.54c-0.3-0.88-1.06-2.68-1.45-3.74c-0.26-0.58-0.56-0.72-2.03-0.72
					C37.26,15.15,34.04,15.15,34.04,15.15z"/>
				<g>
					<circle class="st10" cx="37.13" cy="33.73" r="5.08"/>
					<circle class="st11" cx="37.13" cy="33.73" r="2.54"/>
				</g>
				<g>
					<circle class="st10" cx="10.91" cy="33.73" r="5.08"/>
					<circle class="st11" cx="10.91" cy="33.73" r="2.54"/>
				</g>
				<rect x="1.39" y="9.53" class="st11" width="25.63" height="11.15"/>
				<g>
					<path class="st8" d="M3.63,12.04h3.99c0,0,0.52-0.01,0.52,0.71c0,0.67-0.62,0.6-0.62,0.6l-3.89,0.02V12.04z"/>
					<path class="st8" d="M3.63,9.02v0.49c0,0,4.68,0.06,5.22,0.06c0.68,0,2.35,0.34,2.34,2.66c-0.01,2.19-1.96,2.49-1.96,2.49
						c1.4,0.5,1.55,1.76,1.55,1.76l0.01,3.34L7.67,19.8c0,0-0.01-2.12,0-3.02c0.01-0.9-0.69-0.81-0.69-0.81H3.63v4.14l23.76,0.07V9.02
						H3.63z M21.98,9.67c1.18,0.01,4.42,0,4.42,0s0.09,2.27,0,2.34c-0.09,0.07-6.83,0.04-6.83,0.04C19.59,10.54,21.03,9.67,21.98,9.67z
						M17.03,19.78c-2.01,0.01-5.24,0-5.24,0v-2.61l3.96-0.01c0,0,0.48-0.07,0.48-0.68c0-0.63-0.5-0.63-0.5-0.63l-3.94-0.01v-2.48h4.03
						c0,0,0.44-0.06,0.44-0.66c0-0.67-0.5-0.66-0.5-0.66h-3.96V9.52c0,0,3.92,0,5.31,0c1,0,2.15,0.73,2.2,2.46c0,0,0.02,0.53,0.01,0.7
						c-0.03,0.52-0.04,1.59-1.05,1.74v0.19c0,0,1.19,0.43,1.18,1.78l0,1.1C19.43,17.49,19.03,19.76,17.03,19.78z M26.99,17.03
						c0,1.21-1.39,2.82-2.76,2.82c-2.14,0-4.45-0.06-4.45-0.06V17.2h3.84c0,0,0.38-0.09,0.36-0.7c-0.01-0.62-0.38-0.65-0.44-0.65
		 ...
		 <!-- contact -->
			...
			<svg class="logo" version="1.1" id="Calque_3" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
				...
				<g>
					<path class="st0" d="M31.97,34.42c-1.38,0.28-2.35-0.21-2.9-0.43c-9.93-3.96-16.91-10.86-21.1-20.72c-1.59-3.73,0.8-7.42,5.59-9.36
						c0.71-0.29,1.72,0.44,2.37,0.96c1.08,0.87,1.99,1.95,2.96,2.95c2.97,3.04,2.9,3,0.28,6.53c-0.48,0.65-0.57,2.16-0.14,2.79
						c1.16,1.7,2.65,3.2,4.11,4.65c2.78,2.77,2.78,2.77,5.78,0.06c2.82-2.55,4.61,0.39,6.63,2.19c2.54,2.26,2.98,3.96,1.39,6.09
						C35.43,32.15,34.43,33.52,31.97,34.42z M26.36,26.66c-2.98-1.92-5.8-4.41-8.12-7.12c-3.12-3.64-2.86-3.96,0.32-7.56
						c0.24-0.27,0.36-0.65,0.52-0.95c-1.74-1.81-3.38-3.51-4.99-5.18c-5.22,3.63-5.56,4.88-2.8,10c3.55,6.59,8.64,11.6,15.37,14.93
						c4.99,2.47,6.3,2.06,9.17-2.93c-1.63-1.73-3.25-3.46-4.96-5.29C29.42,23.87,28.19,25,26.36,26.66z"/>
					<path class="st0" d="M41.81,15.54c-1.37-0.07-0.47-0.01-1.67,0C39.16,9.63,35.45,2.44,26.32,1.47c-0.05-1,0.01-0.1-0.06-1.47
						c0.6,0,1.2,0,1.79,0c4.22,1.24,7.01,2.41,9.92,6.01C41.81,10.75,41.81,15.54,41.81,15.54z"/>
					<path class="st0" d="M36.79,15.29c-3.11,0.19-0.66,0.08-1.94,0.08c-0.44-3.63-2.17-7.96-8.44-8.3c0.03-1.14-0.01,0.94,0-1.8
						C32.21,5.28,35.84,8.76,36.79,15.29z"/>
					<path class="st0" d="M26.25,10.38c3.55,0,5.25,1.68,5.71,4.91c-0.63,0-0.64,0.05-1.37,0.01c-0.17-1.17-0.58-3.6-4.28-3.62
						C26.26,11.19,26.26,11.11,26.25,10.38z"/>
				</g>
			</svg>
			<a class="textligne3" href="./contact.php">Contact SAV</a>
		</div>
	</div>  
<nav class="menu main-nav">
					...
					<ul class="sous sous1">
						<table>
							<tbody>
								...
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer1">&#10003;</span> Fotomount</td>
									<td><a href="http://"></a><span class="pointer1">&#10003;</span> Colle</td>
								</tr>
								<tr>
									<th><a href="http://"></a>Reliure par bande thermo-collante</th>
									<td><a href="http://"></a><span class="pointer1">&#10003;</span> Casematic</td>
								...
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer1">&#10003;</span> Case Express</td>
									<td></td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer1">&#10003;</span> Hard Cover Maker 350</td>
									<td></td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer1">&#10003;</span> Hard Cover Maker 650</td>
									<td></td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer1">&#10003;</span> Couvertures clipsées, Book photo sans machine</td>
									<td></td>
								</tr>
							</tbody>
						</table>
						<div class="row basmenu">
						<a href="http://">Voir toutes les reliures thermiques - thermorelieurs - reliures rigides -</a>&nbsp;
					...
					<ul class="sous sous2">
						<table>
							<tbody>
								...
								<tr>
									<th><a href=""></a>Reliure anneau métallique</th>
									<td></td>
								...
								<tr>
									<td></td>
									<th><a href=""></a>Reliure par peigne soudé</th>
									<td><a href="http://"></a><span class="pointer2">&#10003;</span> Spirales plastiques - Spirales Métalliques</td>
								</tr>
								<tr>
								...
								<tr>
									<td></td>
									<td></td>
									<td><a href="http://"></a><span class="pointer2">&#10003;</span> Reliure Channel (en U)</td>
								</tr>
								<tr>
									<td></td>
									<td></td>
									<td><a href="http://"></a><span class="pointer2">&#10003;</span> Baguettes à relier par serrage</td>
								</tr>
							</tbody>
						</table>
						<div class="row basmenu">
						<a href="http://">Machine à relier -</a>&nbsp;
						<a href="http://">Voir tous nos systèmes de reliure -</a>&nbsp;
					...
					<ul class="sous sous3">
						<table>
							<tbody>
								...
								<tr>
									<td><a href="http://"></a><span class="pointer3">&#10003;</span> Pochette de plastification A5, A6, A7</td>
									<td></td>
									<td></td>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer3">&#10003;</span> Pochette de plastification formats badges, cartes, ...</td>
									<th><a href="http://"></a>Bobine de film de plastification</th>
									<th><a href="http://"></a>Films hologramme</th>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer3">&#10003;</span> Pochette de plastification à dos adhésivé</td>
									<td><a href="http://"></a><span class="pointer3">&#10003;</span> Film de plastification à chaud</td>
									<td></td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer3">&#10003;</span> Film de plastification à froid</td>
									<th><a href="http://"></a>Accessoires de plastification</th>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer3">&#10003;</span> Film spécifique (Revo, Ultima, ALM, ...)</td>
									<th><a href="http://"></a>et stockage bobines</th>
								</tr>
								
							</tbody>
						</table>
						<div class="row basmenu">
						<a href="http://">Voir toutes les plastifieuses -</a>&nbsp;
						<a href="http://">Voir toutes les pelliculeuses -</a>&nbsp;
						<a href="http://">Voir tous les laminateurs</a>
						</div>
						<br>
					</ul>
				</div>
		...
		<!-- sous-menu 4 - Détruire -->
				...
				<div class="submenu">
					<ul class="sous sous4">
						<table>
							<tbody>
								...
								<tr>
									...
									<td><a href="http://"></a><span class="pointer4">&#10003;</span> P-1 : Documents courants</td>
									<td></td>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer4">&#10003;</span> Destructeur automatique</td>
									<td><a href="http://"></a><span class="pointer4">&#10003;</span> P-2 : Documents internes</td>
									<td><span class="row minilog"><a href="http://"><img src="/images/logo-ideal.png" alt=""></a>
										<a href="http://"><img src="/images/logo-hsm.png" alt=""></a>
										<a href="http://"><img src="/images/logo-dahle.png" alt=""></a></span></td>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer4">&#10003;</span> Destructeur de bureau</td>
									<td><a href="http://"></a><span class="pointer4">&#10003;</span> P-3 : Documents sensibles</td>
									<td></td>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer4">&#10003;</span> Destructeur centralisé</td>
									<td><a href="http://"></a><span class="pointer4">&#10003;</span> P-4 : Documents confidentiels</td>
									<td><span class="row minilog"><a href="http://"><img src="/images/logo-fellowes.png" alt=""></a>
										<a href="http://"><img src="/images/logo-rexel.png" alt=""></a>
										<a href="http://"><img src="/images/logo-intimus.png" alt=""></a></span></td>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer4">&#10003;</span> Destructeur forte capacité</td>
									<td><a href="http://"></a><span class="pointer4">&#10003;</span> P-5 : Documents ultra-confidentiels</td>
									<td></td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer4">&#10003;</span> P-6 : Documents secrets</td>
									<th><a href="http://"></a>Autres consommables</th>
								</tr>
								<tr>
									<th><a href="http://"></a>Type de coupe</th>
									<td><a href="http://"></a><span class="pointer4">&#10003;</span> P-7 : Documents ultra-secrets</td>
								...
								<tr>
									<td></td>
									<th><a href="http://"></a>et Cartes nationale d'identité</th>
									<td></td>
								</tr>
								<tr>
									<th><a href="http://"></a>Destructeurs multimédia</th>
									<td></td>
									<th><a href="http://"></a>Les destructeurs et la RGPD</th>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer4">&#10003;</span> Destructeur de CD/DVD</td>
									<td></td>
									<td></td>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer4">&#10003;</span> Destructeur de disque dur</td>
									<td></td>
									<th><a href="http://"></a>Presse à balles</th>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer4">&#10003;</span> Démagnétiseur de disque dur</td>
									<td></td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><img class="img_destructeur" src="/images/destructeur-de-passeport.png" alt=""></td>
									<td></td>
								</tr>
						...
						<div class="row basmenu">
						<a href="http://">Choissisez votre destructeur de documents - </a>&nbsp;
						<a href="http://">Voir notre gamme de destructeurs de documents - </a>&nbsp;
						<a href="http://">Voir nos niveaux de sécurité</a>&nbsp;
						</div>
						<br>
					</ul>
				</div>
						...
						<table>
							<tbody>
								...
								<tr>
									...
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Coupeuse plan manuelle</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Lame pour massicot</td>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Massicot électrique</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Coupeuse plan électrique</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Réglette standard pour massicot</td>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Massicot hydraulique</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Coupeuse de support</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Réglette de qualité supérieure pour massicot</td>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Massicot trilame</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Coupeuse de textiles</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Mousse de protection presse massicot</td>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Massicot textile</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Coupeuse XY 4 côtés</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Cale de taquage pour massicot</td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Découpeuse de carte de visite</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Lame et contre-lame pour cisaille</td>
								</tr>
								<tr>
									<th><a href="http://"></a>Rogneuse et cisaille</th>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Découpeuse d'encoche calendrier</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Tête de coupe, lame de rogneuse/coupeuse</td>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Rogneuse</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Découpeuse de trous européens</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Lames et porte-lames pour plotter de découpe</td>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Cisaille de bureau</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Découpeuse de trous oblongs</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Stands, tables, meubles</td>
								</tr>
								<tr>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Cisaille d'atelier</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Découpeuse d'intercalaire</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Lame pour couponeur</td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Découpeuse de photos d'identité</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Contre-partie pour couponeur</td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Coupeuse coin/titres restaurant</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Accessoire pour arrondisseur d'angle</td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Presse à découper pneumatique</td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Consommable de coupe Keencut</td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Arrondisseur d'angle</td>
									<td></td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Coupeuse et rupteur de listings</td>
									<td></td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Presse de découpe</td>
									<td></td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Plotter de découpe Summa</td>
									<td></td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Table de découpe automatique</td>
									<td></td>
								</tr>
								<tr>
									<td></td>
									<td><a href="http://"></a><span class="pointer5">&#10003;</span> Découpeuse de carton</td>
									<td></td>
								</tr>
							</tbody>
						</table>
						<div class="row basmenu">
						<a href="http://">Voir tous nos massicots - </a>&nbsp;
						<a href="http://">Voir toutes nos cisailles - </a>&nbsp;
						<a href="http://">Voir toutes nos coupeuses - </a>&nbsp;
						<a href="http://">Voir toutes nos découpeuses - </a>&nbsp;
						<a href="http://">Voir nos autres matériels de découpe</a>
						</div>
						<br>
					</ul>
				</div>
	...
	<!-- script pour faire disparaitre le header après 200px de scroll -->
	<script>
